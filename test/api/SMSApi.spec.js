...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraSmsMessagingApi.SMSApi();
  });
  ...
  describe('SMSApi', function() {
    ...
    describe('retrieveMessages', function() {
      it('should call retrieveMessages successfully', function(done) {
        //uncomment below and update the code to test retrieveMessages
        //instance.retrieveMessages(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sendMessage', function() {
      it('should call sendMessage successfully', function(done) {
        ...
        //instance.sendMessage(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
