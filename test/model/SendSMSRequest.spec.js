...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraSmsMessagingApi.SendSMSRequest();
  });
  ...
  describe('SendSMSRequest', function() {
    it('should create an instance of SendSMSRequest', function() {
      ...
      //var instane = new TelstraSmsMessagingApi.SendSMSRequest();
      //expect(instance).to.be.a(TelstraSmsMessagingApi.SendSMSRequest);
    });
