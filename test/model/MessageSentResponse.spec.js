...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Messaging.MessageSentResponse();
  });
  ...
  describe('MessageSentResponse', function() {
    it('should create an instance of MessageSentResponse', function() {
      ...
      //var instane = new Messaging.MessageSentResponse();
      //expect(instance).to.be.a(Messaging.MessageSentResponse);
    });
    ...
    it('should have the property numberSegements (base name: "numberSegements")', function() {
      // uncomment below and update the code to test the property numberSegements
      //var instane = new Messaging.MessageSentResponse();
      //expect(instance).to.be();
    });
