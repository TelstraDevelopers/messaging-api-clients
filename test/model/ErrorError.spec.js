...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TelstraSmsMessagingApi.ErrorError();
  });
  ...
  describe('ErrorError', function() {
    it('should create an instance of ErrorError', function() {
      ...
      //var instane = new TelstraSmsMessagingApi.ErrorError();
      //expect(instance).to.be.a(TelstraSmsMessagingApi.ErrorError);
    });
