...
class SMSController {
     ...
     * @returns {Promise}
     */
    static createSendMessage(authorization, payload, callback) {
     ...
     * @returns {Promise}
     */
    static getMessageStatus(authorization, messageId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static retrieveMessages(authorization, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
